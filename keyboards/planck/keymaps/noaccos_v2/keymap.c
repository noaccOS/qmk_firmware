...
[_MAIN] = LAYOUT_planck_grid(
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, KC_LSFT, LOWER, KC_SPC, KC_ENT, RAISE, XXXXXXX, XXXXXXX, XXXXXXX,  XXXXXXX
),
...
[_LOWER] = LAYOUT_planck_grid(
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_LCTL, ADJUST,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
),
